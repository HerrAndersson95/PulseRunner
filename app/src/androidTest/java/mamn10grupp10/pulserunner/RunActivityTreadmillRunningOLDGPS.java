...
public class RunActivityTreadmillRunningOLDGPS extends AppCompatActivity {
    /*Varibles for speed*/
    private int speed = 5;
    ...
    * So hurry up!*/
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(broadcastReceiver, new IntentFilter(RunActivityTreadmillRunningOLDGPS.str_receiver));
